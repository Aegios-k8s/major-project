...
const ACTION_CATEGORY_CARDS = [
  ...
  },
  {
    ...
    description: "Port exposure and service routing issues that expand attack surface.",
    icon: ScanSearch,
  },
  {
    id: "pod",
    title: "Pod",
    description: "Pod and workload runtime security misconfigurations.",
    icon: Boxes,
  },
  {
    id: "container-image",
    title: "Container Image",
    description: "Image hygiene and runtime image hardening issues.",
    icon: Container,
  },
  {
    id: "secrets",
