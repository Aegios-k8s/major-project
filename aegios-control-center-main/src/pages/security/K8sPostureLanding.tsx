...
const CATEGORY_CARDS = [
  ...
  },
  {
    ...
    description: "Exposed ports and service access patterns with higher attack surface.",
    icon: ScanSearch,
  },
  {
    id: "pod",
    title: "Pod",
    description: "Pod-level security and workload posture findings.",
    icon: Boxes,
  },
  {
    id: "container-image",
    title: "Container Image",
    description: "Image and runtime hardening findings for containers.",
    icon: Container,
  },
  {
    id: "secrets",
